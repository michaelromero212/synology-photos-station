...
### Viewer gestures follow Photos, not a video feed

Horizontal swipe pages between items, in order, video to photo to video. That
gesture is not to be repurposed.

Skipping to the next clip is a **button** in the viewer chrome, not a gesture.
An earlier pass had swipe-up for the next video and swipe-down for the previous,
which is the Reels convention dressed up as an obvious one. Photos spends up on
